...
def _resolved_urls(os, pl):
    ...
    urls
    return martin, pmtiles_viewer, versatiles_assets, versatiles_public


@app.cell
def _(martin, mo, pmtiles_viewer, versatiles_assets, versatiles_public):
...
@app.cell
def _(dag_run_states, parquet_path):
...
@app.cell
def _(dag_run_states, parquet_path, pl):
...
@app.cell
def _(Path, dag_run_states, os, pl):
...
@app.cell
def _(dag_run_states, mo, versatiles_assets, versatiles_public):
