...
def _versions(
    ...
    versions
    return cuda_avail, devices


@app.cell
def _(cuda_avail, devices, mo, torch):
    mo.md(f"""
...
@app.cell
def _cuml_kmeans(cuKMeans, cu_make_blobs, pl):
...
@app.cell
def _pyg_gcnconv(GCNConv, pl, torch):
...
@app.cell
def _graphistry_plotter(graphistry, pd, pl):
